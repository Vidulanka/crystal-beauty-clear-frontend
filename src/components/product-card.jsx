     ...
     return (
        < Link to={ "/overview/"+product.productID}className=" w-[250px] m-4 h-[350px]  shadow-2xl">
            ...
            <div className="h-[110px]w-full flex justify-center  flex-col px-4">
                ...
                <p className="text-pink-400">{product.price.toFixed(2)} <span className="line-through text-gray-400 text-sm">{product.price<product.lebeledPrice&&product.lebeledPrice.toFixed(2)}</span>
                 </p>
            </div>
